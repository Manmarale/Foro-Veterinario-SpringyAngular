...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI(){
        ...
        contact.setEmail("manmarale@foro-veterinario.com");
        contact.setName("Foro Veterinario - manmarale");
        contact.setUrl("http://localhost");
        ...
        Info info = new Info()
                .title("Documentación de la API de Foro Veterinario")
                .version("1.0")
                .contact(contact)
                .description("Esta API expone los endpoints para usar Foro Veterinario 🐾.")
                .termsOfService("http://localhost/terminos-de-servicio")
                .license(mitLicense);
